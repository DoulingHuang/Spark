...
if __name__ == "__main__":
    ...
    # Model training
    classifier = LogisticRegression(featuresCol="features",labelCol="label_indexed")
    ...
    model = LogisticRegressionModel.load("hdfs://devenv/user/spark/spark_mllib_101/spam_detection/spam_classifier") 
